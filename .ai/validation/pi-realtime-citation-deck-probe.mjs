...
const deck1 = parse(
	'<pinotator_citation display_ref="[1]" alias="@p1" id="cit_a" origin="transcript" source="assistant/message/raw_exact">Alpha</pinotator_citation>',
);
const deck2 = parse(
	'<pinotator_citation display_ref="[1]" alias="@p1" id="cit_a" origin="transcript" source="assistant/message/raw_exact">Alpha</pinotator_citation><pinotator_citation display_ref="[2]" alias="@p2" id="cit_b" origin="manual" source="manual">Beta</pinotator_citation>',
);
